...
public class Persoana implements IPersoana{
	...
	public int getVarsta(){
		if(this.CNP == null)
			throw  new cnpInexistentExcpetion("CNP null");
		try{
			...
			if (luna > 12 || luna < 1) {
				throw  new cnpException("luna invaldia");
			}

			if (zi > 31 || zi < 1){
				throw new cnpException("ziua invalida");
			}
			...
			throw new cnpException("Cnp invalid contine litere!");
		}
	}
